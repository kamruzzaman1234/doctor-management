...
const Navbar = ()=>{
 ...
 <div className="navbar bg-base-100 ">
  <div className="navbar-start">
    ...
    <Link href={'/'} className="text-3xl font-bold uppercase flex"> <span className="text-green-300">Help 
        <sup className="text-green-700">care</sup></span> <sub><FaUserDoctor  className="text-4xl font-bold text-green-300"/></sub> </Link>
  </div>
